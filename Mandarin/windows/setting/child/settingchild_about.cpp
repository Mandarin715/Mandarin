    ...
    : QWidget(parent), ui(new Ui::SettingChild_About), m_manager(new QNetworkAccessManager(this)), m_localVersion(normalizeVersion(APP_VERSION))
{
    ...
    ui->pushButton->setUrl("https://github.com/Mandarin715/ZcChat2");
    //沿用旧版ZcChat的GitHub图标
    ...
    ui->pushButton_2->setUrl("https://github.com/Mandarin715/ZcChat2/issues/new/choose");
    //沿用旧版ZcChat的Issue图标
    ...
    QTimer::singleShot(0, this, [this]()
        ...
        QNetworkReply *reply = m_manager->get(QNetworkRequest(
            QUrl("https://api.github.com/repos/Mandarin715/ZcChat2/releases")));
